...
public class _12_TGDropdownTest extends Base{
    ...
    public void confirmationAlert(){
        ...
        WebElement resultText2 = driver.findElement(By.id("action"));
        Assert.assertEquals(resultText2.getText(), "You confirmed the alert by clicking OK.");
        Waiter.pause(2);
