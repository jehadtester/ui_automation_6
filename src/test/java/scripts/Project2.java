...
public class Project2 extends Base {
    ...
    public void validateTheInvalidLoginWithTheWrongUsername(){
        ...
        project2Page.usernameInputBox.sendKeys("John");
        project2Page.passwordInputBox.sendKeys("Test1234");
        project2Page.loginButton.click();
    ...
    public void validateTheInvalidLoginWithTheWrongPassword(){
        ...
        project2Page.usernameInputBox.sendKeys("TechGlobal");
        project2Page.passwordInputBox.sendKeys("1234");
        project2Page.loginButton.click();
